...
import mobileBeforeImage from "figma:asset/mobile-before.png";
import mobileAfterImage from "figma:asset/mobile-after.png";

interface HomeProps {
  onNavigate: (page: string) => void;
  onPortfolioModalChange?: (isOpen: boolean) => void;
}

export function Home({ onNavigate, onPortfolioModalChange }: HomeProps) {
    ...
    <div className='min-h-screen'>
      ...
      <section className='py-20 bg-[#0a0a0f]'>
        ...
        <div className='px-5 lg:px-60'>
          ...
          <div className='relative'>
            ...
            <div className='relative'>
              <BeforeAfterSlider
                beforeImage={isMobile ? mobileBeforeImage : beforeImage}
                afterImage={isMobile ? mobileAfterImage : afterImage}
      ...
      <div id='portfolio'>
        <Portfolio
          ...
          onModalStateChange={onPortfolioModalChange}
        />
      </div>
