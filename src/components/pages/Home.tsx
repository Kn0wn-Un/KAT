...
export function Home({ onNavigate }: HomeProps) {
  ...
  const heroImages = [
    ...
    {
      src: 'https://images.unsplash.com/photo-1614382765323-4a46d78ebf65?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb250ZW1wb3JhcnklMjBhcmNoaXRlY3R1cmUlMjB0d2lsaWdodxlbnwxfHx8fDE3NjIwODQ0NzV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      ...
      <section id="about" className="py-20 px-5 lg:px-60 bg-[#0a0a0f]">
        <div className="max-w-6xl mx-auto">
          ...
          <div>
            ...
            {/* All Team Members - Responsive Grid */}
            <div className="grid grid-cols-2 md:grid-cols-2 gap-6 md:gap-12 max-w-4xl mx-auto px-4 md:px-0">
              {/* First two members */}
              ...
              {/* Third member - centered on mobile, aligned in grid on desktop */}
              <div className="col-span-2 md:col-span-2 flex justify-center">
                <div
                  className="glass-effect rounded-2xl overflow-hidden group hover:border-[#A8C0D6]/30 transition-all duration-300 backdrop-blur-xl w-[calc(50%-0.75rem)] md:w-full md:max-w-md"
                  style={{
                    boxShadow: '0 0 40px rgba(168, 192, 214, 0.15), 0 0 80px rgba(168, 192, 214, 0.1)',
                  }}
                >
