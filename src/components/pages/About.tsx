...
import { ChevronLeft, ChevronRight, Building2, Palette, Eye, Users, TrendingUp, Lightbulb, PaintbrushVertical, CheckCircle2, PhoneCall, Box } from 'lucide-react';
import { Carousel, CarouselContent, CarouselItem, CarouselPrevious, CarouselNext, type CarouselApi } from '../ui/carousel';
import beforeImage from 'figma:asset/fbc6bf91ccec7fa326d3f474621907b37ec61eec.png';
import afterImage from 'figma:asset/9d73078fe5d924aeb91929e754d2b5b2dcf18ea1.png';
import katLogo from 'figma:asset/444bf92e5917804e6307c17f8cf03002306eb41c.png';
import kowshikImage from 'figma:asset/d26e410788eea83a13d290a371a01a1a33e1a3d5.png';
import arpithaImage from 'figma:asset/59c43cb2b2fc556a0c6cbdc9d8fb27a579d8a4d2.png';
import adithyaImage from 'figma:asset/be3e873ba5ce6486c2e82aafab0082e58c72bfed.png';
...
export function About({ onNavigate }: AboutProps) {
  ...
  const testimonials = [
    {
      ...
      initials: 'RK',
      stars: 5,
      review: 'Stunning photorealistic renders helped us secure investors within weeks. Their attention to lighting and material details is exceptional. Highly recommend!',
    ...
    },
    {
      ...
      initials: 'PS',
      stars: 4.5,
      review: 'Understood our minimalist design perfectly. Interior renders captured every nuance. The 3D-Streaming let clients experience spaces before construction. Professional team!',
    ...
    },
    {
      ...
      initials: 'AM',
      stars: 4,
      review: 'VR tour was a game-changer. Investors could virtually walk through before groundbreaking. Quality rivals international studios at a fraction of the cost!',
    ...
    },
    {
      ...
      initials: 'NC',
      stars: 5,
      review: 'Renders so realistic, clients thought they were photographs! Material textures and lighting are remarkable. Essential part of my design process now.',
    ...
    },
    {
      ...
      initials: 'VR',
      stars: 4.5,
      review: 'Exceptional renders for our township. Aerial views helped communicate our vision effectively. Outstanding understanding of landscaping and urban design. Fast delivery!',
    ...
    },
    {
      ...
      initials: 'SD',
      stars: 4,
      review: 'Night renders with ambient lighting were breathtaking! Team collaborated closely and incorporated feedback promptly. Final renders became key assets in our pitch deck.',
  ...
  const services = [
    {
      title: 'Architecture',
      image: 'https://images.unsplash.com/photo-1633109633238-e982d5b61f9f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcmNoaXRlY3R1cmFsJTIwM2QlMjByZW5kZXJpbmd8ZW58MXx8fHwxNzYxOTgwMzMwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
    {
    ...
    {
      title: 'Real Estate',
      image: 'https://images.unsplash.com/photo-1760561148422-bbb515696fb7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWFsJTIwZXN0YXRlJTIwbW9kZXJuJTIwYnVpbGRpbmd8ZW58MXx8fHwxNzYxOTc4ODQzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
    {
      title: '3D-Streaming',
      image: 'https://images.unsplash.com/photo-1693771406380-dd37260e282f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHwzNjAlMjBwYW5vcmFtYSUyMGFyY2hpdGVjdHVyZXxlbnwxfHx8fDE3NjE5ODAzMzJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
    {
      title: 'VR Tours',
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative z-10 px-5 lg:px-20 w-full animate-fade-in">
          <div className="max-w-3xl">
            ...
            <p className="text-base md:text-lg text-white/80 font-poppins mb-8 leading-relaxed">
              Delivers immersive architectural visualizations, Photorealistic renders & virtual experiences that bridge the gap between design & perception
            </p>
        ...
        <div className="px-5 lg:px-60">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/70 font-poppins max-w-2xl mx-auto">
              Experience the transformation from raw 3D models to photorealistic visualizations
            </p>
          </div>
        </div>
      ...
      <section className="py-20 px-5 lg:px-60 bg-[#0a0a0f]">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-montserrat text-white">
            Why <span className="text-[#A8C0D6]">3D Visualization</span> Is Essential ?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="group relative">
            ...
            <div className="relative glass-effect rounded-2xl p-8 md:p-10 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-500">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-[#A8C0D6] font-poppins text-sm tracking-wide">For Developers & Builders</p>
              </div>
              ...
              <p className="text-white/70 font-poppins mb-8 leading-relaxed">
                Transform your unbuilt projects into investor magnets with AI-powered visualizations
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3 group/item">
                  ...
                  <div>
                    <h4 className="text-white font-poppins mb-1">Realistic Exteriors & Walkthroughs</h4>
                    <p className="text-white/60 text-sm font-poppins">Market unbuilt projects with stunning photorealistic renderings</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 group/item">
                  ...
                  <div>
                    <h4 className="text-white font-poppins mb-1">Attract Premium Investors</h4>
                    <p className="text-white/60 text-sm font-poppins">Create compelling visuals for brochures, ads, and presentations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 group/item">
                  ...
                  <div>
                    <h4 className="text-white font-poppins mb-1">Accelerate Pre-Sales</h4>
                    <p className="text-white/60 text-sm font-poppins">Increase sign-offs and secure funding faster with premium visuals</p>
                  </div>
                </div>
              </div>
          ...
          <div className="group relative">
            ...
            <div className="relative glass-effect rounded-2xl p-8 md:p-10 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-500">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="w-1.5 h-1.5 rounded-full bg-[#A8C0D6] animate-pulse"></div>
                <p className="text-[#A8C0D6] font-poppins text-sm tracking-wide">For Architects & Interior Designers</p>
              </div>
              ...
              {/* Description */}
              <p className="text-white/70 font-poppins mb-8 leading-relaxed">
                Transform concepts into compelling visuals that win clients and streamline approvals
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3 group/item">
                  ...
                  <div>
                    <h4 className="text-white font-poppins mb-1">Realistic Renders & Walkthroughs</h4>
                    <p className="text-white/60 text-sm font-poppins">Save time on client approvals with photorealistic visualizations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 group/item">
                  ...
                  <div>
                    <h4 className="text-white font-poppins mb-1">Showcase Complete Design Systems</h4>
                    <p className="text-white/60 text-sm font-poppins">Present furniture layouts, color palettes, and materials in realistic spaces</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 group/item">
                  ...
                  <div>
                    <h4 className="text-white font-poppins mb-1">Visualize Before Construction</h4>
                    <p className="text-white/60 text-sm font-poppins">Present design concepts convincingly to clients and investors</p>
                  </div>
                </div>
              </div>
      ...
      {/* Portfolio Section */}
      <div id="portfolio">
        <Portfolio onNavigate={onNavigate} onOpenContactModal={() => setIsModalOpen(true)} />
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-montserrat mb-6 text-white flex items-center justify-center gap-4">
              About <img src={katLogo} alt="KAT" className="h-10 md:h-14 w-auto" />
            </h2>
            ...
            <div className="glass-effect rounded-2xl p-5 md:p-8 mb-8">
              <p className="text-sm md:text-lg text-white/90 font-poppins leading-relaxed">
                At KAT, we combine art, form, and essence — <span className="text-[#A8C0D6]">Kala, Aakruthi, Tatva</span> — to transform architectural concepts into visuals that inspire and persuade.
              </p>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="text-center px-5 md:px-12">
              <p className="text-xs md:text-2xl text-white/90 font-poppins leading-relaxed italic">
                "At KAT, we understand that a powerful visual can bridge the gap between imagination and reality. We combine artistic flair with advanced rendering technologies to meticulously craft visuals that not only showcase every detail of your design but also evoke emotion and tell your project's unique story. Whether you are an architect, developer, or interior designer, we are committed to providing you with striking visualizations that accelerate approvals, enhance your marketing and captivate your audience."
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-montserrat mb-4">
                <span 
                  ...
                  style={{
                    ...
                    backgroundImage: 'linear-gradient(to right, #FF6B6B, #FF8A65, #FFA726, #FFD54F, #FFEB3B, #66BB6A, #26C6DA, #42A5F5, #5C6BC0, #AB47BC, #9C27B0)',
                  }}
                >
                  Our Process
                </span>
              ...
              <p className="text-white/70 font-poppins text-sm md:text-base">
                Four strategic steps to transform your vision into stunning photorealistic visuals
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
              ...
              <div className="group relative">
                ...
                <div className="relative glass-effect rounded-xl md:rounded-2xl p-3 md:p-6 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-300">
                  ...
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-[#A8C0D6] to-[#6B8BA0] flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                    <span className="font-montserrat text-white text-xs md:text-base">01</span>
                  </div>

                  {/* Icon */}
                  <div className="mb-2 md:mb-4">
                    <PhoneCall size={16} className="text-[#A8C0D6] md:w-6 md:h-6" />
                  </div>
              ...
              <div className="group relative">
                ...
                <div className="relative glass-effect rounded-xl md:rounded-2xl p-3 md:p-6 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-300">
                  {/* Number Badge */}
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-[#A8C0D6] to-[#6B8BA0] flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                    <span className="font-montserrat text-white text-xs md:text-base">02</span>
                  </div>

                  {/* Icon */}
                  <div className="mb-2 md:mb-4">
                    <Palette size={16} className="text-[#A8C0D6] md:w-6 md:h-6" />
                  </div>
              ...
              <div className="group relative">
                ...
                <div className="relative glass-effect rounded-xl md:rounded-2xl p-3 md:p-6 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-300">
                  {/* Number Badge */}
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-[#A8C0D6] to-[#6B8BA0] flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                    <span className="font-montserrat text-white text-xs md:text-base">03</span>
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-white/60 text-xs md:text-sm font-poppins mb-2 md:mb-4 leading-relaxed">
                    Precise modeling, natural lighting, and photorealistic texturing.
                  </p>
              ...
              <div className="group relative">
                ...
                <div className="relative glass-effect rounded-xl md:rounded-2xl p-3 md:p-6 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-300">
                  {/* Number Badge */}
                  <div className="w-8 h-8 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-gradient-to-br from-[#A8C0D6] to-[#6B8BA0] flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                    <span className="font-montserrat text-white text-xs md:text-base">04</span>
                  </div>

                  {/* Icon */}
                  <div className="mb-2 md:mb-4">
                    <CheckCircle2 size={16} className="text-[#A8C0D6] md:w-6 md:h-6" />
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-white/60 text-xs md:text-sm font-poppins mb-2 md:mb-4 leading-relaxed">
                    High-resolution renders optimized for presentations and marketing.
                  </p>
          ...
          <div>
            <h3 className="text-3xl md:text-4xl font-montserrat text-center mb-12 text-white flex items-center justify-center gap-4">
              Team <img src={katLogo} alt="KAT" className="h-10 md:h-12 w-auto" />
            </h3>
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-12 max-w-4xl mx-auto px-4 md:px-0 mb-6 md:mb-12">
              {team.slice(0, 2).map((member, index) => (
                <div
                  ...
                  style={{
                    boxShadow: '0 0 40px rgba(168, 192, 214, 0.15), 0 0 80px rgba(168, 192, 214, 0.1)',
                  }}
                >
      ...
      <section className="py-20 px-5 lg:px-60 bg-gradient-to-b from-[#0a0a0f] to-[#0a0a0f]/95">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/70 font-poppins text-sm md:text-base max-w-2xl mx-auto">
            Real experiences from architects, developers, and designers who trusted us with their visions
          </p>
        </div>
                ...
                <CarouselItem key={testimonial.id} className="pl-2 md:pl-4">
                  <div 
                    className={`relative rounded-2xl overflow-hidden transition-all duration-700 ${
                      activeTestimonial === index ? 'scale-100' : 'scale-95 opacity-60'
                    }`}
                  >
                    {/* Primary Glow effect - contained inside card */}
                    <div 
                      className={`absolute inset-0 bg-gradient-to-br ${testimonial.glowColor} blur-2xl transition-all duration-700 ${
                        activeTestimonial === index ? 'opacity-100 animate-testimonial-glow' : 'opacity-0'
                      }`}
                    ></div>

                    {/* Secondary inner glow */}
                    <div 
                      className={`absolute inset-4 bg-gradient-to-br ${testimonial.glowColor} blur-xl transition-all duration-700 ${
                    ...
                    >
                      ...
                      <div className="flex gap-1 mb-4">
                        ...
                        {testimonial.stars % 1 !== 0 && (
                          <svg className="w-5 h-5" viewBox="0 0 20 20">
                            ...
                            <path fill={`url(#half-fill-${testimonial.id})`} d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                          </svg>
                        )}
                        {[...Array(5 - Math.ceil(testimonial.stars))].map((_, i) => (
                          <svg key={`empty-${i}`} className="w-5 h-5 fill-[#4A5568]" viewBox="0 0 20 20">
                            <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                          </svg>
                        ))}
                      </div>
                      ...
                      <div className="flex items-center gap-3 pt-4 border-t border-white/10">
                        <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${testimonial.gradient} flex items-center justify-center`}>
                          <span className="text-white font-montserrat">{testimonial.initials}</span>
                        </div>
                        <div>
                          <h4 className="text-white font-poppins">{testimonial.name}</h4>
                          <p className="text-[#A8C0D6] text-sm font-poppins">{testimonial.role}</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="group relative rounded-2xl overflow-hidden">
              {/* Glow effect - contained inside card */}
              <div className={`absolute inset-0 bg-gradient-to-br ${testimonial.glowColor} blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              
              {/* Secondary inner glow */}
              <div className={`absolute inset-4 bg-gradient-to-br ${testimonial.glowColor} blur-xl opacity-0 group-hover:opacity-60 transition-opacity duration-500`}></div>
              ...
              <div className="relative glass-effect rounded-2xl p-6 h-full backdrop-blur-xl bg-white/5 border border-white/10 group-hover:border-[#A8C0D6]/30 transition-all duration-500 flex flex-col">
                ...
                <div className="flex gap-1 mb-4">
                  ...
                  {testimonial.stars % 1 !== 0 && (
                    <svg className="w-5 h-5" viewBox="0 0 20 20">
                      <defs>
                        <linearGradient id={`half-fill-desktop-${testimonial.id}`}>
                          <stop offset="50%" stopColor="#FFD700" />
                          <stop offset="50%" stopColor="#4A5568" />
                        </linearGradient>
                      </defs>
                      <path fill={`url(#half-fill-desktop-${testimonial.id})`} d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                    </svg>
                  )}
                  {[...Array(5 - Math.ceil(testimonial.stars))].map((_, i) => (
                    <svg key={`empty-${i}`} className="w-5 h-5 fill-[#4A5568]" viewBox="0 0 20 20">
      ...
      <OtherServicesModal isOpen={isOtherServicesOpen} onClose={() => setIsOtherServicesOpen(false)} />
    </div>
  );
}